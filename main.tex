...
\begin{keypoints*}
\begin{itemize}
\item Infrastructure is complicated and difficult to setup for teachers.
\item TIaaS provides "one click" infrastructure for trainers.
\item It enables remote training via a dashboard where instructors can follow student progress.
\end{itemize}
\end{keypoints*}
