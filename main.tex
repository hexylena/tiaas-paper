...
\author[11]{Nate~Coraor}                 % 0000-0001-8083-2963
...
\begin{itemize}
    \item Conceptualization: HR, BG; % Equal
    \item Methodology: HR;
    \item Software: HR, CH, JD, AB, GC; % HR Lead
    \item Validation: WB, BSS, JHJ, SH; % All Equal
    %\item Formal Analysis: ;
    \item Investigation: WB, BSS, JHJ; % All Equal
    \item Resources: BG, GC, SG, NC, AB, MZ; % All Equal
    %\item Data Curation: ;
    \item Writing – Original Draft Preparation: HR, BG; % HR Lead
    \item Writing – Review \& Editing: HR, SH, JD, MZ, WB; % HR Lead
    \item Visualization: HR, CH; % HR Lead
    \item Supervision: AS, BG; % Equal
    %\item Project Administration: ;
    \item Funding Acquisition: BG, AS, SH, AB, HR. % All Equal
\end{itemize}
